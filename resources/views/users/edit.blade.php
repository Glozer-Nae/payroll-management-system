    ...
    <div class="col-md-8 col-lg-6">
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header bg-white border-bottom-0 pt-4 px-4 pb-0">
                ...
                <p class="text-muted small mt-1">Update profile and permissions for {{ $user->name }}.</p>
            </div>
                ...
                <form method="POST" action="{{ route('users.update', $user) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" value="{{ old('name', $user->name) }}" class="form-control bg-light border-0 py-2 shadow-none" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email" value="{{ old('email', $user->email) }}" class="form-control bg-light border-0 py-2 shadow-none" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light border-0 text-muted"><i class="bi bi-toggle-on"></i></span>
