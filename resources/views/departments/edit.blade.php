    ...
    <div class="col-md-8 col-lg-6">
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header bg-white border-bottom-0 pt-4 px-4 pb-0">
                ...
                <p class="text-muted small mt-1">Update the name of the selected department.</p>
            </div>
                ...
                <form action="{{ route('departments.update', $department->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" value="{{ old('name', $department->name) }}" class="form-control bg-light border-0 py-2 shadow-none" required>
                        </div>
                    </div>
